        ...
        % header
         ...
         % rules
          \begin{tabular}{c}
            ...
            \\
            $\inference{(\textbf{for}\:lstv_{1}\:p\:k \mapsto c_{for}) \in h}{h \star \textbf{for}\:lstv_{2}\:(y.\:c_{1})\:(z.\:c_{2}) \leadsto c_{for}[lstv_{2}\:/\:lstv_{1},\:(\lambda y.\:h \star c_{1})\:/\:p, (\lambda z.\:h \star c_{2})\:/\:k]}[\hl{E-HandFor}]$\\
            \\
