...
/* package thesis-0.1.0.0 */
#ifndef VERSION_thesis
#define VERSION_thesis "0.1.0.0"
#endif /* VERSION_thesis */
#ifndef MIN_VERSION_thesis
#define MIN_VERSION_thesis(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_thesis */
...
#define CURRENT_COMPONENT_ID "thesis-0.1.0.0-inplace-thesis"
